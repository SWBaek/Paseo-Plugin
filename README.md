...
- `file-browser`의 다운로드 기능을 사용할 경우 로그인된 Tailscale CLI와 [Tailnet 전용 Serve 설정](plugins/file-browser/README.md#download-transport)
...
동작 로직이 있는 파일을 변경했다면 해당 플러그인의 테스트를 실행해야 합니다. 전체 테스트는 다음 명령으로 한 번에 실행할 수 있습니다.
