...
export type RequestSkillsModal = (agentId: string) => Promise<boolean>;
...
export function registerSkillsPills(
  client: PluginClientContext,
  Component: ComponentType<PluginComposerPillProps>,
  requestModal: RequestSkillsModal,
): PluginCleanup {
  ...
  function syncPill(agent: {
    ...
    const remove = client.addComposerPill({
      id: "skills",
      title: "Insert a session skill prompt",
      workspaceId,
      agentId,
      Component,
      onPress() {
